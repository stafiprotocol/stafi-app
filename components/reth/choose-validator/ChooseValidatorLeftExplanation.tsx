...
export const ChooseValidatorLeftExplanation = () => {
  ...
  const text =
    page === 1
      ...
      : page === 2
      ? "Once your node reaches 32ETH,  you can deploy a pool contract to deposit 32ETH to the deposit contract of ETH1.0 After that, please wait for validating progress on ETH2.0."
